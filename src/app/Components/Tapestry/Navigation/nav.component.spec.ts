...
describe('NavComponent', () => {
  ...
  // Use a Subject to control router events
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        // provideRouter handles the 'root' and internal state correctly
        provideRouter([]),
      ],
    }).compileComponents();
    ...
    // Instead of replacing the whole router object (which causes 'root' errors),
    // we define the properties used by the component.
    ...
    // Trigger initial detection to initialize the toSignal
  ...
  describe('Menu Visibility', () => {
    it('should update shouldShowCreate based on URL events', () => {
      ...
      // fixture.detectChanges() is critical to update computed signals
      fixture.detectChanges();
  ...
  describe('Modal and Menu Interaction', () => {
    it('should open modal and close menu', () => {
